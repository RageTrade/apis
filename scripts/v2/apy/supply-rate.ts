...
const dataUrl = "https://yields.llama.fi/poolsEnriched?pool=7aab7b0f-01c1-4467-bc0d-77826d870f19"
...
export const getSupplyApy = async (networkName: NetworkName) =>  {
  ...
  const seniorTvl = (await dn.dnGmxSeniorVault.getVaultMarketValue()).toNumber()
  const dnUsdcDeposited = (await dn.dnGmxJuniorVault.dnUsdcDeposited()).toNumber()
